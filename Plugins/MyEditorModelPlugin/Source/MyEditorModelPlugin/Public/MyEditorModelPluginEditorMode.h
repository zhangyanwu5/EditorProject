...
#include "MyEditorModelPluginEditorMode.generated.h"
 ...
 */
UCLASS()
class UMyEditorModelPluginEditorMode : public UEdMode
{
	GENERATED_BODY()

public:
	const static FEditorModeID EM_MyEditorModelPluginEditorModeId;

	static FString SimpleToolName;
	static FString InteractiveToolName;

	UMyEditorModelPluginEditorMode();
	virtual ~UMyEditorModelPluginEditorMode();
