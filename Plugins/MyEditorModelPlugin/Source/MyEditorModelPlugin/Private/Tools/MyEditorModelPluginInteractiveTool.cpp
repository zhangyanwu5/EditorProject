...
#include "MyEditorModelPluginInteractiveTool.h"
...
#define LOCTEXT_NAMESPACE "UMyEditorModelPluginInteractiveTool"

/*
 * ToolBuilder
 */

UInteractiveTool* UMyEditorModelPluginInteractiveToolBuilder::BuildTool(const FToolBuilderState & SceneState) const
{
	UMyEditorModelPluginInteractiveTool* NewTool = NewObject<UMyEditorModelPluginInteractiveTool>(SceneState.ToolManager);
...
UMyEditorModelPluginInteractiveToolProperties::UMyEditorModelPluginInteractiveToolProperties()
{
...
void UMyEditorModelPluginInteractiveTool::SetWorld(UWorld* World)
{
	check(World);
...
void UMyEditorModelPluginInteractiveTool::Setup()
{
	...
	Properties = NewObject<UMyEditorModelPluginInteractiveToolProperties>(this, "Measurement");
...
void UMyEditorModelPluginInteractiveTool::OnUpdateModifierState(int ModifierID, bool bIsOn)
{
...
FInputRayHit UMyEditorModelPluginInteractiveTool::CanBeginClickDragSequence(const FInputDeviceRay& PressPos)
{
...
void UMyEditorModelPluginInteractiveTool::OnClickPress(const FInputDeviceRay& PressPos)
{
...
void UMyEditorModelPluginInteractiveTool::OnClickDrag(const FInputDeviceRay& DragPos)
{
	UpdatePosition(DragPos.WorldRay);
}


FInputRayHit UMyEditorModelPluginInteractiveTool::FindRayHit(const FRay& WorldRay, FVector& HitPos)
{
...
void UMyEditorModelPluginInteractiveTool::UpdatePosition(const FRay& WorldRay)
{
...
void UMyEditorModelPluginInteractiveTool::UpdateDistance()
{
	Properties->Distance = FVector::Distance(Properties->StartPoint, Properties->EndPoint);
}


void UMyEditorModelPluginInteractiveTool::OnPropertyModified(UObject* PropertySet, FProperty* Property)
{
...
void UMyEditorModelPluginInteractiveTool::Render(IToolsContextRenderAPI* RenderAPI)
{
