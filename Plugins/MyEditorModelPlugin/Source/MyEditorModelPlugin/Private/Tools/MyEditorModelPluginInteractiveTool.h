...
#include "MyEditorModelPluginInteractiveTool.generated.h"


/**
 * Builder for UMyEditorModelPluginInteractiveTool
 */
UCLASS()
class MYEDITORMODELPLUGIN_API UMyEditorModelPluginInteractiveToolBuilder : public UInteractiveToolBuilder
{
	GENERATED_BODY()
...
/**
 * Property set for the UMyEditorModelPluginInteractiveTool
 */
UCLASS(Transient)
class MYEDITORMODELPLUGIN_API UMyEditorModelPluginInteractiveToolProperties : public UInteractiveToolPropertySet
{
	GENERATED_BODY()

public:
	UMyEditorModelPluginInteractiveToolProperties();
...
/**
 * UMyEditorModelPluginInteractiveTool is an example Tool that allows the user to measure the 
 ...
 */
UCLASS()
class MYEDITORMODELPLUGIN_API UMyEditorModelPluginInteractiveTool : public UInteractiveTool, public IClickDragBehaviorTarget
{
	GENERATED_BODY()
...
protected:
	...
	UPROPERTY()
	TObjectPtr<UMyEditorModelPluginInteractiveToolProperties> Properties;
